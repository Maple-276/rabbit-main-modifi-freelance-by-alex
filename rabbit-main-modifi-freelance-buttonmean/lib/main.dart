...
Future<void> main() async {
  ...
  if(!kIsWeb){
    ...
    await Firebase.initializeApp(options: const FirebaseOptions(
      ...
      // Note: Using Android appId, ensure firebase_options.dart (if generated by FlutterFire CLI) is correct for iOS too.
      appId: '1:654682130983:android:9010d271bc2b1d175d5c02',
      messagingSenderId: '654682130983',
      projectId: 'rabbit-8cace',
    ));
  } else {
    // Web initialization will be handled in index.html
    // Ensure WidgetsFlutterBinding is initialized for web plugins if needed before runApp
    WidgetsFlutterBinding.ensureInitialized();
  }
