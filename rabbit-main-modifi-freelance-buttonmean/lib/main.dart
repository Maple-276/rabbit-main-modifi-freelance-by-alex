...
Future<void> main() async {
  ...
  if(!kIsWeb){
    ...
    // Check if the default app exists before initializing to avoid duplicate app error.
    if (Firebase.apps.isEmpty) {
      await Firebase.initializeApp(); // Initialize using native config files
    }
  } else {
    // WEB PLATFORM
    // Initialization is handled by firebase JS SDK in index.html
