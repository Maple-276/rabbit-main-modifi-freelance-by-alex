      ...
      onTap: () {
        ...
        ResponsiveHelper.showDialogOrBottomSheet(context, CartBottomSheetWidget(
          ...
          callback: (CartModel cartModel) {
            showCustomSnackBarHelper(getTranslated('updated_in_cart', context), isError: false, type: SnackBarType.cart, showProgressBar: true);
          },
        ));
      ...
      children: [
        InkWell(
          ...
          child: Container(
            ...
            child: Icon(Icons.remove, size: Dimensions.fontSizeExtraLarge, color: Theme.of(context).hintColor.withOpacity(0.4)),
          ),
        ),
